...
type
  ...
  phy_reg_read_cv* = proc (eth: ptr esp_eth_mediator_t; phy_addr: uint32; phy_reg: uint32; reg_value: ptr uint32): EspErrorCode {.cdecl.}
  ...
  phy_reg_write_cb* = proc (eth: ptr esp_eth_mediator_t; phy_addr: uint32; phy_reg: uint32; reg_value: uint32): EspErrorCode {.cdecl.}
  ...
  stack_input_cb* = proc (eth: ptr esp_eth_mediator_t; buffer: ptr uint8; length: uint32): EspErrorCode {.cdecl.}

  on_state_changed_cb* = proc (eth: ptr esp_eth_mediator_t; state: esp_eth_state_t; args: pointer): EspErrorCode {.cdecl.}
