...
proc esp_netif_new*(esp_netif_config: ptr esp_netif_config_t): ptr esp_netif_t {.
    importc: "esp_netif_new", header: "esp_netif.h".}
## *
...
proc esp_netif_destroy*(esp_netif: ptr esp_netif_t) {.importc: "esp_netif_destroy",
    header: "esp_netif.h".}
## *
...
proc esp_netif_is_netif_up*(esp_netif: ptr esp_netif_t): bool {.
    importc: "esp_netif_is_netif_up", header: "esp_netif.h".}
## *
...
proc esp_netif_get_netif_impl_index*(esp_netif: ptr esp_netif_t): cint {.
    importc: "esp_netif_get_netif_impl_index", header: "esp_netif.h".}
## *
##  @}
##
## *
...
proc esp_ip4addr_ntoa*(`addr`: ptr esp_ip4_addr_t; buf: cstring; buflen: cint): cstring {.
    importc: "esp_ip4addr_ntoa", header: "esp_netif.h".}
## *
...
proc esp_netif_get_io_driver*(esp_netif: ptr esp_netif_t): esp_netif_iodriver_handle {.
    importc: "esp_netif_get_io_driver", header: "esp_netif.h".}
## *
...
proc esp_netif_get_handle_from_ifkey*(if_key: cstring): ptr esp_netif_t {.
    importc: "esp_netif_get_handle_from_ifkey", header: "esp_netif.h".}
## *
...
proc esp_netif_get_flags*(esp_netif: ptr esp_netif_t): esp_netif_flags_t {.
    importc: "esp_netif_get_flags", header: "esp_netif.h".}
## *
...
proc esp_netif_get_ifkey*(esp_netif: ptr esp_netif_t): cstring {.
    importc: "esp_netif_get_ifkey", header: "esp_netif.h".}
## *
...
proc esp_netif_get_desc*(esp_netif: ptr esp_netif_t): cstring {.
    importc: "esp_netif_get_desc", header: "esp_netif.h".}
## *
...
proc esp_netif_next*(esp_netif: ptr esp_netif_t): ptr esp_netif_t {.
    importc: "esp_netif_next", header: "esp_netif.h".}
## *
...
proc esp_netif_get_nr_of_ifs*(): csize_t {.importc: "esp_netif_get_nr_of_ifs",
                                        header: "esp_netif.h".}
## *
##  @}
##
